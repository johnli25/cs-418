...
def dday(coord1, coord2, dim):
    ...
    delta = (coord2[0] - coord1[0], coord2[1] - coord1[1]) # tuple coords
...
def ddax(coord1_list, coord2_list, coord3_list, dim): 
    ...
    for i in range(min(len(line1), len(line2))): 
        ...
        delta = (line2[i][dim] - line1[i][dim], line2[i][1] - line1[i][1]) # tuple coords
    ...
    line_extended = line1
    if i == len(line1): # line1 finished, line2 still needs to be rasterized
        line_extended = line2
    if i == len(line2): # line2 finished, line1 still needs to be rasterized
        line_extended = line1
    ...
    for i in range(len(line3) - 1): 
        ...
        delta = (line3[i][dim] - line_extended[mid_offset + i][dim], line3[i][1] - line_extended[mid_offset + i][1]) # tuple coords
