...
for line in txt_input_clean:
    ...
    if line[0] == 'tri':
        ...
        for vertex_rest in dda_rest:
            ...
            # debugging purposes only (for clip plane)-don't forget to remove during final version!
                if ((x,y) in unclipped_green_fragment or (x,y) in unclipped_red_fragment):
                    continue
        ...
        if clipplane_flag == True: # debugging purposes only (for clip plane)-don't forget to remove during final version!
            pass
            # debugging white tri
